...
#include "custom_interfaces/srv/detail/goto__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::srv::Goto_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::Goto_Request & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::srv::Goto_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::Goto_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::Goto_Request *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_Goto_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, Goto_Request)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_Goto_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_custom_interfaces
cdr_serialize(
  const custom_interfaces::srv::Goto_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: succes
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::srv::Goto_Response & ros_message)
{
  // Member: succes
  cdr >> ros_message.succes;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces::srv::Goto_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::srv::Goto_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<custom_interfaces::srv::Goto_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_Goto_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, Goto_Response)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_Goto_Response__handle;
}
...
{
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_Goto__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, Goto)() {
  return &custom_interfaces::srv::typesupport_fastrtps_cpp::_Goto__handle;
}
