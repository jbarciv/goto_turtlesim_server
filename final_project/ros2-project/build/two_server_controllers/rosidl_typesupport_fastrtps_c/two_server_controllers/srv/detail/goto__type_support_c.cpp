...
#include "two_server_controllers/srv/detail/goto__rosidl_typesupport_fastrtps_c.h"
...
#include "two_server_controllers/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Goto_Request__ros_msg_type = two_server_controllers__srv__Goto_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_two_server_controllers
size_t get_serialized_size_two_server_controllers__srv__Goto_Request(
  const void * untyped_ros_message,
...
static uint32_t _Goto_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_two_server_controllers__srv__Goto_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_two_server_controllers
size_t max_serialized_size_two_server_controllers__srv__Goto_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = two_server_controllers__srv__Goto_Request;
    is_plain =
      (
...
static size_t _Goto_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_two_server_controllers__srv__Goto_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, two_server_controllers, srv, Goto_Request)() {
...
using _Goto_Response__ros_msg_type = two_server_controllers__srv__Goto_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_two_server_controllers
size_t get_serialized_size_two_server_controllers__srv__Goto_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Goto_Response__ros_msg_type * ros_message = static_cast<const _Goto_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_two_server_controllers__srv__Goto_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_two_server_controllers
size_t max_serialized_size_two_server_controllers__srv__Goto_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = two_server_controllers__srv__Goto_Response;
    is_plain =
      (
...
static size_t _Goto_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_two_server_controllers__srv__Goto_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, two_server_controllers, srv, Goto_Response)() {
...
// already included above
// #include "two_server_controllers/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "two_server_controllers/srv/goto.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, two_server_controllers, srv, Goto)() {
  return &Goto__handle;
}
